...
const AppleLogo = () => (
  <svg width="80" height="96" viewBox="0 0 170 170" className="text-white fill-current">
...
export const ShutdownScreen = ({ onShutdownComplete }: ShutdownScreenProps) => {
  ...
  useEffect(() => {
    ...
    // Complete shutdown after progress finishes
  ...
  return (
    <div 
      ...
      onClick={!isBooting ? handleClick : undefined}
    >
      {/* Apple Logo */}
