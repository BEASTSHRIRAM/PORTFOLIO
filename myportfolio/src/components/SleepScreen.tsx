...
export const SleepScreen = ({ onWakeUp }: SleepScreenProps) => {
  ...
  useEffect(() => {
    ...
    // Complete wake up after progress finishes
  ...
  return (
    <div 
      ...
      onClick={!isWaking ? handleClick : undefined}
    >
      {/* Apple Logo */}
      ...
      {/* Progress Bar or Click to Wake Up */}
      {isWaking ? (
        <>
