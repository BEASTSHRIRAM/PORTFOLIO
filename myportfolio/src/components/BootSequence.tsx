...
const AppleLogo = () => (
  <svg width="60" height="72" viewBox="0 0 170 170" className="text-white fill-current">
...
export const BootSequence = ({ onBootComplete }: BootSequenceProps) => {
  const [stage, setStage] = useState<'booting' | 'welcome' | 'complete'>('booting');
  ...
  useEffect(() => {
    ...
    // Show welcome message halfway through
    const welcomeTimer = setTimeout(() => {
      setStage('welcome');
    }, 1500);

    // Complete boot after progress finishes
  ...
  return (
    <div className="fixed inset-0 z-[200] bg-black flex flex-col items-center justify-center">
      ...
      {/* Welcome Message */}
      {stage === 'welcome' && (
        <div className="text-white/90 text-lg font-medium text-center px-4 animate-fade-in">
